 ...
 *  modified tima_rpcd --> tima_command
 */
...
int tima_command_recv(int fd, void *buf, size_t len, int flags)
{
	int rc;
...
int tima_command_send(int fd, const void *buf, size_t len, int flags)
{
	int rc;
